...
#if defined(STM32F4)
		rt_memheap_init(&ccm_heap, "ccm", (void *)0x10000000, 0x10000);
#endif
#endif
...
#if defined(PKG_USING_SEGGER_RTT)
extern void rt_hw_jlink_console_init();
		rt_hw_jlink_console_init();
#else
		rt_device_t uart_device = rt_device_find("uart1");
