...
#if defined(PRUD_ERIC888_DISP)||defined(PRUD_ERIC820_DISP)
extern SPI_HandleTypeDef hspi4;
extern void M2M_HAL_SPI_RxCpltCallback(void);
extern void M2M_HAL_SPI_TxCpltCallback(void);
#endif
