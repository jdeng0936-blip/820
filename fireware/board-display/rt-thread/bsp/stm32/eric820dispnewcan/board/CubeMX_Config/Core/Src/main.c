...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOI, COMM2_Pin|COMM1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(G4_PWR_GPIO_Port, G4_PWR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI2_NSS_Pin|TC_SCL_Pin|TC_SDA_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : COMM2_Pin COMM1_Pin */
  GPIO_InitStruct.Pin = COMM2_Pin|COMM1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOI, &GPIO_InitStruct);

  /*Configure GPIO pin : G4_PWR_Pin */
  GPIO_InitStruct.Pin = G4_PWR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(G4_PWR_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : HUM_DET_Pin */
  GPIO_InitStruct.Pin = HUM_DET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(HUM_DET_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : AD_RESET_Pin PG10 */
  GPIO_InitStruct.Pin = AD_RESET_Pin|GPIO_PIN_10;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pins : TC_SCL_Pin TC_SDA_Pin */
  GPIO_InitStruct.Pin = TC_SCL_Pin|TC_SDA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
